...
```
4. В скрипте есть два сообщения — поменяйте их на свои. По-дефолту зашиты хоткеи F14 и F15 (да, такие существуют, до F20). Проще всего назначить их на клавиши в [VIA](via.md), но можно поменять тут — как больше нравится
